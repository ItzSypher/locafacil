      ...
      <AnimatePresence>
        {messageVisible && !isOpen && (
          <motion.div
            ...
            className="on-light bg-white text-text-dark type-meta p-4 rounded-2xl shadow-xl mb-4 relative max-w-[250px] border border-slate-100"
          >
            ...
            <div className="mt-3 flex gap-2">
              <button 
                ...
                className="flex-1 bg-brand-accent text-white type-label py-2 rounded-lg hover:bg-brand-glow transition-colors cursor-pointer"
              >
                Sim, por favor
              </button>
              <button 
          ...
          >
            <div className="bg-brand-dark p-4 flex items-center gap-4 relative shrink-0">
              ...
              <div className="flex-1 z-10">
                <h4 className="type-subtitle text-white">Locagora</h4>
            ...
            <div className="p-3 bg-white border-t border-slate-100 shrink-0">
              ...
              <a href="https://api.whatsapp.com/send?phone=5521968540185&text=Ol%C3%A1,%20Locagora!%20Vim%20pelo%20site." target="_blank" rel="noopener noreferrer">
                <motion.button
                  ...
                  whileTap={{ scale: 0.98 }}
                  className="w-full bg-[#25D366] hover:bg-[#1ebd5b] text-white font-semibold py-2.5 rounded-xl flex items-center justify-center gap-2 shadow-md transition-all cursor-pointer text-sm"
                >
