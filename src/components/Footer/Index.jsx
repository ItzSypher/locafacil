        ...
        >
            ...
            <nav className="space-y-3">
              {[
                ...
                <Link
                  key={link.label}
                  to={link.href}
                  className="block type-meta text-text-secondary hover:text-brand-accent transition-colors duration-200 cursor-pointer py-3 -my-1"
                >
                  {link.label}
                </Link>
              ))}
          ...
          <motion.div variants={fadeInUp}>
            ...
            <div className="space-y-3">
              <a href="tel:2127861404" className="flex items-center gap-2 type-meta type-numeric text-text-secondary hover:text-brand-accent transition-colors cursor-pointer py-3 -my-1">
                <svg className="w-4 h-4 flex-shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
                  <path strokeLinecap="round" strokeLinejoin="round" d="M2.25 6.75c0 8.284 6.716 15 15 15h2.25a2.25 2.25 0 002.25-2.25v-1.372c0-.516-.351-.966-.852-1.091l-4.423-1.106c-.44-.11-.902.055-1.173.417l-.97 1.293c-.282.376-.769.542-1.21.38a12.035 12.035 0 01-7.143-7.143c-.162-.441.004-.928.38-1.21l1.293-.97c.363-.271.527-.734.417-1.173L6.963 3.102a1.125 1.125 0 00-1.091-.852H4.5A2.25 2.25 0 002.25 4.5v2.25z" />
                </svg>
                (21) 2786-1404
              </a>
              <a href="tel:21968540185" className="flex items-center gap-2 type-meta type-numeric text-text-secondary hover:text-brand-accent transition-colors cursor-pointer py-3 -my-1">
                <svg className="w-4 h-4 flex-shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
                  <path strokeLinecap="round" strokeLinejoin="round" d="M10.5 1.5H8.25A2.25 2.25 0 006 3.75v16.5a2.25 2.25 0 002.25 2.25h7.5A2.25 2.25 0 0018 20.25V3.75a2.25 2.25 0 00-2.25-2.25H13.5m-3 0V3h3V1.5m-3 0h3m-3 18.75h3" />
                </svg>
                (21) 96854-0185
              </a>
              <a href="mailto:gerencia@locafacilaluguel.com" className="flex items-center gap-2 type-meta text-text-secondary hover:text-brand-accent transition-colors cursor-pointer py-3 -my-1">
                <svg className="w-4 h-4 flex-shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
