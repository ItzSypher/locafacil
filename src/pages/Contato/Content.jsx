            ...
            <div className="flex flex-col justify-center items-center text-center bg-white p-8 rounded-2xl shadow-sm border border-slate-100">
              ...
              <a href="https://api.whatsapp.com/send?phone=5521968540185&text=Ol%C3%A1,%20Locafacil!%20Gostaria%20de%20tirar%20uma%20d%C3%BAvida." target="_blank" rel="noopener noreferrer" className="w-full">
                <motion.button
                  ...
                  whileTap={{ scale: 0.98 }}
                  className="w-full bg-[#25D366] hover:bg-[#1ebd5b] text-white font-semibold px-8 py-4 rounded-xl transition-colors duration-300 flex items-center justify-center gap-3 cursor-pointer"
                >
