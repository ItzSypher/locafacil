...
export default function Reservar() {
  return (
    <div className="min-h-screen overflow-x-hidden">
      <Topbar />
      <main className="relative min-h-screen bg-hero-gradient overflow-hidden flex items-center" id="reservar">
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 pt-28 pb-24 relative z-10">
          <h1 className="type-headline text-text-primary text-center mb-10 text-balance">
            Reserve seu veículo
          </h1>
          <SearchWidget />
        </div>
